...
-   Our **test RMSLE** of 0.1698 is very close to the article's test RMSLE of 0.1694, indicating similar performance on unseen data.

-   Our **train RMSLE** of 0.1426 is slightly better than the article's train RMSLE of 0.1669.

-   We also included MAPE as an additional metric, providing further insight into the model's accuracy. Our **test MAPE** is 0.2238, and **train MAPE** is 0.1345.

-   The number of estimators in our model was 355, significantly higher than the 64 estimators used in the article. This difference indicates that our model required more trees to achieve optimal performance, which might be due to differences in data preprocessing or parameter tuning.
