...
trainIndex <- createDataPartition(housing_prices_data_clean$totalPrice, p = 0.85, list = FALSE) train_data <- housing_prices_data_clean[trainIndex, ] 
...
test_predictions <- ifelse(test_predictions < 0, 0.01, test_predictions) train_predictions <- ifelse(train_predictions < 0, 0.01, train_predictions) 
```
